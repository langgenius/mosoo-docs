...
This guide preserves the v1 contract. For direct harness/model invocation, optional saved presets and recorded usage, see [durable sessions with v2](/docs/durable-sessions-v2) and the [v2 OpenAPI snapshot](/docs/openapi/mosoo-openapi.v2.en.generated.json). Confirm the supported v2 schema and budget policy on your selected deployment before use.
