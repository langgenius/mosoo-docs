...
Choose the reusable runtime template for packages, setup script, variables, and network-policy intent. If the Agent has no explicit Environment, the Project default applies. A new session freezes the selected Environment revision.
