...
Sign in at [try.mosoo.ai](https://try.mosoo.ai). mosoo creates a **Default App** for a new account. Use the App switcher to create or open another App when you need a separate resource and usage boundary.
