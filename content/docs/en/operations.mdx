...
![Files are grouped by Project, Agent, Thread, attachment, and artifact role.](/docs/images/product/files.png)
...
![Project Usage shows estimated spend, model calls, token trends, Agents, and models.](/docs/images/product/app-usage.png)
