...
package、setup script、変数、network policy をまとめた再利用可能な runtime template を選びます。Agent に明示的な Environment がない場合は Project default が適用されます。新しい session は選択した Environment revision を固定して使用します。Task Agent は Full または Limited のネットワークアクセスを利用でき、Assistant Agent には Full が必要です。詳しくは [Environment のネットワークポリシー](/docs/ja/environments#ネットワークポリシー)を参照してください。
