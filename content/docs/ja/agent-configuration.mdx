...
package、setup script、変数、network-policy intent をまとめた再利用可能な runtime template を選びます。Agent に明示的な Environment がない場合は Project default が適用されます。新しい session は選択した Environment revision を固定して使用します。
