...
本文介绍 v1。无需发布即可调用已保存的私有 Agent，请参阅 [v2 持久会话](/docs/zh-Hans/durable-sessions-v2)（正在 staging 验收）。
...
<Cards>
  ...
  <Card title="事件与流式传输" href="/docs/zh-Hans/events-and-streaming">
    通过快照或 SSE stream 读取 Thread event。
  </Card>
  <Card title="文件" href="/docs/zh-Hans/files">
    上传文件并挂载到 Thread message。
  </Card>
  <Card title="错误与限制" href="/docs/zh-Hans/errors-and-limits">
    处理重试、幂等冲突、限流和无效请求。
  </Card>
</Cards>
