...
![Files 可按 Project、Agent、Thread、attachment 与 artifact role 查看。](/docs/images/product/files.png)
...
![Project Usage 展示 estimated spend、model calls、token trend、Agents 和 models。](/docs/images/product/app-usage.png)
